#!/usr/bin/env python3
"""iMovie HD -> modern media + import-safe FCPXML (Stage 6.5).

Stage 6.5 builds on the stable Stage 6 import and adds title awareness without changing the rendered timeline. It mirrors Apple-generated FCPXML by
...
def main() -> None:
    ...
    xml_path = output_dir / f"{safe_name(project_name)}-Stage6.5.fcpxml"
